...
const startProviderHandler = () => {
  ...
  completions[3].documentation = new vscode.MarkdownString(
  ...
  completions[6].documentation = new vscode.MarkdownString(
...
const endProviderHandler = (
  ...
  switch (true) {
    ...
    case linePrefix.endsWith('rgb.'): {
      ...
      completion1.documentation = new vscode.MarkdownString(
    ...
    case linePrefix.endsWith('lcd.'): {
      ...
      completion0.documentation = new vscode.MarkdownString(
      ...
      completion2.documentation = new vscode.MarkdownString(
      ...
      completion3.documentation = new vscode.MarkdownString(
      ...
      completion3.insertText = new vscode.SnippetString(
      ...
      completion4.documentation = new vscode.MarkdownString(
      ...
      completion5.documentation = new vscode.MarkdownString(
      ...
      completion5.insertText = new vscode.SnippetString(
      ...
      completion6.documentation = new vscode.MarkdownString(
        'Draw a rectangle in screen.\n\n@_param_ `x1` —— The X coordinate of the start point.\n\n@_param_ `y1` —— The Y coordinate of the start point.\n\n@_param_ `x2` —— The X coordinate of the end point.\n\n@_param_ `y2` —— The Y coordinate of the end point.\n\n@_param_ `color` —— The color of the rectangle.'
      );
      completion6.insertText = new vscode.SnippetString(
      ...
      completion7.documentation = new vscode.MarkdownString(
      ...
      completion7.insertText = new vscode.SnippetString(
      ...
      completion8.documentation = new vscode.MarkdownString(
      ...
      completion9.insertText = new vscode.SnippetString(
      ...
      completion11.insertText = new vscode.SnippetString(
      ...
      completion12.insertText = new vscode.SnippetString(
